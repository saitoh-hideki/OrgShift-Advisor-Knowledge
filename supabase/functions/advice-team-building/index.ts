...
以下のチーム構築の詳細に基づいて、具体的で実践的なアドバイスを3つ提供してください。
...
${context.team_building_type ? `- チーム構築の種類: ${context.team_building_type}` : ''}
${context.team_size ? `- チームサイズ: ${context.team_size}人` : ''}
${context.team_maturity ? `- チームの成熟度: ${context.team_maturity}` : ''}
${context.team_context ? `- チームの状況: ${context.team_context}` : ''}
